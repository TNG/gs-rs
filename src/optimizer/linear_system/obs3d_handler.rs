...
use crate::factor_graph::variable::{FixedType, VehicleVariable3D, LandmarkVariable3D};
...
fn update_H_submatrix(H: &mut DMatrix<f64>, added_matrix: &Matrix<f64, Dynamic, Dynamic, SliceStorage<f64,Dynamic,Dynamic,U1,U9>>, row_type: &FixedType, col_type: &FixedType) {
...
fn update_b_subvector(b: &mut DVector<f64>, added_vector: &Vector<f64, Dynamic, SliceStorage<f64,Dynamic,U1,U1,U9>>, fixed_type: &FixedType) {
